...
/**
 * Base interface comparable to {@link Number} - but an interface and not an abstract class.
 *
...
public interface INumber
{
  ...
  /**
   * Returns the value of the specified number as a {@code byte}, which may involve rounding or
   * truncation.
   * <p>
  ...
  /**
   * Returns the value of the specified number as a {@code short}, which may involve rounding or
   * truncation.
   * <p>
