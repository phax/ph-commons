...
/**
 * This implementation of {@link IIntIDFactory} reads IDs from a device. It does it by reserving a
...
public abstract class AbstractPersistingIntIDFactory implements IIntIDFactory
{
   ...
   *         otherwise or {@link com.helger.base.CGlobal#ILLEGAL_UINT} in case of an error.
   */
