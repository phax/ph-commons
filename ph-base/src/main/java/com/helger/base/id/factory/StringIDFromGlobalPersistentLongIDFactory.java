...
/**
 * An {@link IStringIDFactory} implementation that uses a constant prefix and a long supplied from
 * {@link GlobalIDFactory#getNewPersistentLongID()} to create unique IDs.
 *
