 ...
 * This is the primitive type specialization of {@link Consumer} for {@code char}. Unlike most other
 * functional interfaces, {@code ICharConsumer} is expected to operate via side-effects.
 * <p>
...
public interface ICharConsumer
{
  ...
  /**
   * Returns a composed {@code CharConsumer} that performs, in sequence, this operation followed by
   ...
   * @return a composed {@code CharConsumer} that performs in sequence this operation followed by
