 ...
 * Note: Does not implement Iterable because the returned iterator would either be an Iterator over
 * the list in which case you can use {@link #getAllCallbacks()} directly or the returned Iterator
 * would not be thread-safe and that is not an option for this type.
 *
