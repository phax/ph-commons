...
public enum ESortOrder implements ISortOrderIndicator
{
  ...
  /**
   * @return The associated value for this sort order. The value can directly be used in compare
   *         methods to multiply the initial return value with this value to have the correct
   *         ordering.
   */
  @Nonnegative
  public int getValue ()
  ...
  /**
   * Get the alternate sort order. If the current sort order is ascending, the result will be
   * descending and if this is descending, the return will be ascending.
   *
