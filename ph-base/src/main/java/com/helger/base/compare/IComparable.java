...
public interface IComparable <DATATYPE> extends Comparable <DATATYPE>
{
   ...
   * @param aOther
   *        value to compare to
   * @return <code>true</code> if this value is greater than the provided values, <code>false</code>
   *         if not.
   * @since 8.6.5
   */
   ...
   * @param aOther
   *        value to compare to
   * @return <code>true</code> if this value is greater or equal than the provided values,
   ...
   * @param aOther
   *        value to compare to
   * @return <code>true</code> if this value is lower than the provided values, <code>false</code>
   *         if not.
   * @since 8.6.5
   */
   ...
   * @param aOther
   *        value to compare to
   * @return <code>true</code> if this value is lower or equal than the provided values,
   *         <code>false</code> if not.
   * @since 8.6.5
   */
