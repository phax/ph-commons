...
public final class GenericReflection
{
   ...
   *
   * @param aObjs
   *        The object array. May be <code>null</code>. No contained element may be
   *        <code>null</code>.
   ...
   * @param aArgs
   *        The arguments to be passed into the method. May be <code>null</code> . If not
   *        <code>null</code>, the members of the array may not be <code>null</code> because
   *        otherwise the classes of the arguments cannot be determined and will throw an Exception!
  ...
  public static <RETURNTYPE> RETURNTYPE invokeMethod (@NonNull final Object aSrcObj,
                                                      ...
                                                      @Nullable final Object... aArgs) throws NoSuchMethodException, IllegalAccessException, InvocationTargetException
  {
  ...
  public static <RETURNTYPE> RETURNTYPE invokeStaticMethod (@NonNull final String sClassName,
                                                            @NonNull final String sMethodName,
                                                            @Nullable final Object... aArgs) throws NoSuchMethodException, IllegalAccessException, InvocationTargetException, ClassNotFoundException
  {
  ...
  /**
   * Create a new instance of the class identified by the passed object. The default constructor
   * will be invoked.
   *
   * @param <DATATYPE>
   ...
   */
  @NonNull
  public static <DATATYPE> DATATYPE newInstance (@NonNull final DATATYPE aObj) throws IllegalAccessException, NoSuchMethodException, InvocationTargetException, InstantiationException
  {
  ...
  public static <DATATYPE> DATATYPE newInstance (@Nullable final Class <? extends DATATYPE> aClass)
  {
    if (aClass != null)
      ...
      {
        /*
         * Catch all exceptions because any exception thrown from the constructor may also end up in
         * this catch block
         */
