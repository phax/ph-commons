...
public class NonBlockingByteArrayInputStream extends InputStream
{
   ...
   *        the input buffer.
   */
  public NonBlockingByteArrayInputStream (final byte @NonNull [] aBuf)
  {
   ...
   */
  public NonBlockingByteArrayInputStream (final byte @NonNull [] aBuf, final boolean bIsCopyNeeded)
  {
                                          ...
                                          final boolean bIsCopyNeeded)
  {
    ...
    m_aBuf = bIsCopyNeeded ? Arrays.copyOfRange (aBuf, nOfs, nOfs + nLen) : aBuf;
