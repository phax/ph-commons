...
public class ByteBufferOutputStream extends OutputStream implements IWriteToStream
{
  ...
  /**
   * Create a new object with the {@link #DEFAULT_BUF_SIZE} buffer size and it can grow.
   */
  ...
  /**
   * @return <code>true</code> if this buffer can grow, <code>false</code> if not.
   */
  ...
  /**
   * Get everything as a big byte array, without altering the ByteBuffer. This works only if the
  ...
  /**
   * Write everything currently contained to the specified buffer. If the passed buffer is too
   * small, a {@link java.nio.BufferOverflowException} is thrown. The copied elements are removed
   * from this streams buffer.
   *
   * @param aDestBuffer
  ...
  /**
   * Writes the current content to the passed buffer. The copied elements are removed from this
   * streams buffer.
   *
   * @param aBuf
  ...
  /**
   * Write current content to the passed byte array. The copied elements are removed from this
   * streams buffer.
   *
   * @param aBuf
  ...
  /**
   * Write everything to the passed output stream and clear the contained buffer. This works only if
   * the contained ByteBuffer has a backing array.
   *
   * @param aOS
  ...
  /**
   * Write everything to the passed output stream and optionally clear the contained buffer. This
   * works only if the contained ByteBuffer has a backing array.
   *
   * @param aOS
   *        The output stream to write to. May not be <code>null</code>.
   * @param bClearBuffer
   *        <code>true</code> to clear the buffer, <code>false</code> to not do it. If
   *        <code>false</code> you may call {@link #reset()} to clear it manually afterwards.
   * @throws IOException
   *         In case of IO error
   */
  ...
  /**
   * Get the content as a string without modifying the buffer. This works only if the contained
