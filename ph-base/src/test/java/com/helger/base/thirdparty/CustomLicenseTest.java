...
public final class CustomLicenseTest
{
  ...
  public void testAll ()
  {
    ...
    BaseTestHelper.testDefaultImplementationWithEqualContentObject (cl2,
                                                                    new CustomLicense ("cl1", "License", null, null));
    BaseTestHelper.testDefaultImplementationWithEqualContentObject (cl,
                                                                    new CustomLicense ("cl1",
                                                                                       "License",
                                                                                       Version.parse ("1.2"),
                                                                                       "url"));
    BaseTestHelper.testDefaultImplementationWithDifferentContentObject (cl,
