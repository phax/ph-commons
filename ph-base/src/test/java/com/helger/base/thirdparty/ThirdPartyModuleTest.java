...
public final class ThirdPartyModuleTest
{
  ...
  public void testAll ()
  {
    ...
    mod = new ThirdPartyModule ("displayname", "owner", ELicense.APACHE1, Version.parse ("1.1"), null);
    assertEquals ("displayname", mod.getDisplayName ());
    assertEquals ("owner", mod.getCopyrightOwner ());
    assertEquals (ELicense.APACHE1, mod.getLicense ());
    ...
    mod = new ThirdPartyModule ("displayname", "owner", ELicense.APACHE1, Version.parse ("1.1"), "url", true);
    assertEquals ("displayname", mod.getDisplayName ());
    assertEquals ("owner", mod.getCopyrightOwner ());
    assertEquals (ELicense.APACHE1, mod.getLicense ());
    assertEquals (new Version (1, 1), mod.getVersion ());
  ...
  public void testStd ()
  {
    BaseTestHelper.testDefaultImplementationWithEqualContentObject (new ThirdPartyModule ("displayname",
                                                                                          "owner",
                                                                                          ELicense.APACHE1),
    ...
    final ThirdPartyModule mod = new ThirdPartyModule ("displayname",
                                                       ...
                                                       "url",
                                                       true);
    BaseTestHelper.testDefaultImplementationWithEqualContentObject (mod,
                                                                    new ThirdPartyModule ("displayname",
                                                                                          "owner",
                                                                                          ELicense.APACHE1,
                                                                                          Version.parse ("1.1"),
                                                                                          "url",
                                                                                          true));
    BaseTestHelper.testDefaultImplementationWithDifferentContentObject (mod,
