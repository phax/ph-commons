...
public final class FactoryNewInstanceTest
{
  ...
  {
    assertEquals (FactoryNewInstance.create (String.class), FactoryNewInstance.create (String.class));
    assertNotEquals (FactoryNewInstance.create (String.class), FactoryNewInstance.create (StringBuilder.class));
  }
}
