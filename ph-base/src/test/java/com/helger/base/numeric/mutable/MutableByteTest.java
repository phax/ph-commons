...
public final class MutableByteTest
{
  ...
  public void testMutableByte ()
  {
    ...
    BaseTestHelper.testDefaultImplementationWithEqualContentObject (new MutableByte (-7), new MutableByte (-7));
    BaseTestHelper.testDefaultImplementationWithDifferentContentObject (new MutableByte (6), new MutableByte (7));
    BaseTestHelper.testGetClone (new MutableByte (Integer.MAX_VALUE));
  }
}
