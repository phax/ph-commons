...
public final class MutableIntTest
{
  ...
  public void testMutableInt ()
  {
    ...
    BaseTestHelper.testDefaultImplementationWithEqualContentObject (new MutableInt (-7), new MutableInt (-7));
    BaseTestHelper.testDefaultImplementationWithDifferentContentObject (new MutableInt (6), new MutableInt (7));
    BaseTestHelper.testGetClone (new MutableInt (Integer.MAX_VALUE));
  }
}
