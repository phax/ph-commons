...
public final class MutableShortTest
{
  ...
  public void testMutableByte ()
  {
    ...
    BaseTestHelper.testDefaultImplementationWithEqualContentObject (new MutableShort (-7), new MutableShort (-7));
    BaseTestHelper.testDefaultImplementationWithDifferentContentObject (new MutableShort (6), new MutableShort (7));
    BaseTestHelper.testGetClone (new MutableShort (Integer.MAX_VALUE));
  }
}
