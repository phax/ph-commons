...
public final class MutableBooleanTest
{
  ...
  public void testMutableBoolean ()
  {
    ...
    BaseTestHelper.testDefaultImplementationWithEqualContentObject (new MutableBoolean (true),
                                                                    new MutableBoolean (true));
    BaseTestHelper.testDefaultImplementationWithDifferentContentObject (new MutableBoolean (true),
                                                                        new MutableBoolean (false));
    BaseTestHelper.testGetClone (new MutableBoolean (false));
  }
}
