...
public final class MutableCharTest
{
  ...
  public void testMutableChar ()
  {
    ...
    BaseTestHelper.testDefaultImplementationWithEqualContentObject (new MutableChar (-7), new MutableChar (-7));
    BaseTestHelper.testDefaultImplementationWithDifferentContentObject (new MutableChar (6), new MutableChar (7));
    BaseTestHelper.testGetClone (new MutableChar (Integer.MAX_VALUE));
  }
}
