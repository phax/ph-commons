...
class CacheBuilderBase <IMPLTYPE extends CacheBuilderBase <IMPLTYPE>> implements IGenericImplTrait <IMPLTYPE>
{
   ...
   * {@link CacheEvictionScheduler#MIN_EVICTION_INTERVAL}; shorter positive intervals are rejected
   * by <code>build()</code> to prevent starving the shared scheduler thread.
   *
   * @param a
