...
public final class RegExHelper
{
  ...
  /**
   * Split the passed text with the given regular expression. If you do not need a regular
   * expression, {@link StringHelper#getExploded(String, String)} is a faster option.
   *
   * @param sText
   *        The text to be split. May be <code>null</code>.
   * @param sRegEx
   *        The regular expression to use for splitting. May neither be <code>null</code> nor empty.
   * @return An empty array if the text is <code>null</code>, a non- <code>null</code> array
  ...
  /**
   * Split the passed text with the given regular expression returning at most the given number of
   * tokens. If you do not need a regular expression,
   ...
   *        The regular expression to use for splitting. May neither be <code>null</code> nor empty.
   * @param nLimit
   *        The maximum number of tokens to return if the value is &gt; 0. If the value is &le; 0 it
   *        has no effect and all tokens are returned.
   * @return An empty array if the text is <code>null</code>, a non- <code>null</code> array
   *         otherwise. If both text and regular expression are <code>null</code> an empty array is
   *         returned as well since the text parameter is checked first.
   */
   ...
   * @param sRegEx
   *        The regular expression to use for splitting. May neither be <code>null</code> nor empty.
   * @return An empty list if the text is <code>null</code>, a non- <code>null</code> list
  ...
  /**
   * Split the passed text with the given regular expression. If you do not need a regular
   * expression, {@link StringHelper#getExploded(String, String, int)} is a faster option.
   *
   * @param sText
   *        The text to be split. May be <code>null</code>.
   * @param sRegEx
   ...
   *
   * @param sRegEx
   *        The regular expression to use. May neither be <code>null</code> nor empty.
   * @param sValue
  ...
  /**
   * A shortcut helper method to determine whether a string matches a certain regular expression or
   * not.
   *
   * @param sRegEx
   *        The regular expression to be used. The compiled regular expression pattern is cached.
  ...
  /**
   * Convert an identifier to a programming language identifier by replacing all non-word characters
   * with an underscore ("_").
   *
   * @param s
   *        The string to convert. May be <code>null</code> or empty.
   * @return The converted string or <code>null</code> if the input string is <code>null</code>.
   */
  @Nullable
   ...
   *        The string to convert. May be <code>null</code> or empty.
   * @param cReplacement
   *        The replacement character to be used for all non-identifier characters
   * @return The converted string or <code>null</code> if the input string is <code>null</code>.
   */
  @Nullable
   ...
   *        The string to convert. May be <code>null</code> or empty.
   * @param sReplacement
   *        The replacement string to be used for all non-identifier characters. May be empty but
   *        not be <code>null</code>.
   * @return The converted string or <code>null</code> if the input string is <code>null</code>.
   *         Maybe an invalid identifier, if the replacement is empty, and the identifier starts
   *         with an illegal character, or if the replacement is empty and the source string only
   ...
   * Note: this method may be a performance killer, as it calls {@link Pattern#compile(String)} each
   * time, which is CPU intensive and has a synchronization penalty.
   *
   * @param sRegEx
  ...
  /**
   * Get the values of all groups (RegEx <code>(...)</code>) for the passed value.<br>
   * Note: groups starting with "?:" are non-capturing groups (e.g. <code>(?:a|b)</code>)
   *
   * @param sRegEx
   *        The regular expression containing the groups
   * @param sValue
   *        The value to check
   * @return <code>null</code> if the passed value does not match the regular expression. An empty
