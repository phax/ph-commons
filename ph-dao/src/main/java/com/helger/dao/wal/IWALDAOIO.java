...
/**
 * The DAO file IO API. Used in WAL DAOs.
 *
 * @author Philip Helger
 */
public interface IWALDAOIO extends Serializable
{
  /**
   ...
   */
  @Nonnull
  default FileIOError deleteFile (@Nonnull final File aFile)
  {
    return FileOperationManager.INSTANCE.deleteFile (aFile);
  }
}
