...
/**
 * An implementation of the {@link IHasTextWithArgs} interface that always returns a constant
 * string. Use this only for texts that never need to be translated!
 *
