...
{
  private static final String PROBE_CLASS = PhSecurityWithoutBCProbe.class.getName ();
  ...
  public void testStandardX509HelpersWithoutBC () throws Exception
  {
    ...
    })
    {
      ...
      assertEquals ("http://pki-crl.symauth.com/ca_6a937734a393a0805bf33cda8b331093/LatestCRL.crl|1|0,6",
                    sResult);
    }
  }

  private static void _assertClassIsHidden (final ClassLoader aClassLoader, final String sClassName)
  {
    try
    {
