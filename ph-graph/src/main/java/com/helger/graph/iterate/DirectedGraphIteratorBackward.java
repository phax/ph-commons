...
/**
 * A simple backward iterator for directed graphs (following the incoming nodes).
 *
...
public final class DirectedGraphIteratorBackward implements ICommonsIterableIterator <IMutableDirectedGraphNode>
{
  ...
  /**
   * Current stack. It contains the current node plus an iterator of the incoming relations of the
   * node
   */
  ...
  /**
   * Constructor iterating incoming relations from the start node, optionally filtering relations.
   *
   * @param aStartNode
   *        The node to start iterating from. May not be <code>null</code>.
