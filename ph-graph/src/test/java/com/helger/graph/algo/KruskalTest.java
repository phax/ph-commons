...
public final class KruskalTest
{
  ...
  public void testBasic ()
  {
    ...
    g.createNode ("5");
    g.createNode ("6");
    g.createRelation ("1", "2").attrs ().setAttribute (ATTR_WEIGHT, 4);
    g.createRelation ("1", "3").attrs ().setAttribute (ATTR_WEIGHT, 2);
    g.createRelation ("1", "4").attrs ().setAttribute (ATTR_WEIGHT, 5);
    g.createRelation ("2", "5").attrs ().setAttribute (ATTR_WEIGHT, 3);
    g.createRelation ("2", "3").attrs ().setAttribute (ATTR_WEIGHT, 4);
    g.createRelation ("4", "3").attrs ().setAttribute (ATTR_WEIGHT, 4);
    g.createRelation ("4", "6").attrs ().setAttribute (ATTR_WEIGHT, 6);
    g.createRelation ("3", "5").attrs ().setAttribute (ATTR_WEIGHT, 3);
    g.createRelation ("3", "6").attrs ().setAttribute (ATTR_WEIGHT, 5);
    g.createRelation ("5", "6").attrs ().setAttribute (ATTR_WEIGHT, 4);
