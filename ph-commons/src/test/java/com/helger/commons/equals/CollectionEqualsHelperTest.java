...
public final class CollectionEqualsHelperTest
{
  ...
  public void testList ()
  {
    ...
    assertFalse (CollectionEqualsHelper.equalsCollection (aCont, ArrayHelper.newArray ("a", "b", "c")));
  }
  ...
  public void testMap ()
  {
    ...
    assertFalse (CollectionEqualsHelper.equalsCollection (aMap, ArrayHelper.newArray ("a", "b", "c")));
  }
  ...
  public void testArray ()
  {
    ...
    assertTrue (CollectionEqualsHelper.equalsCollection (aArray, ArrayHelper.newArray ("a", "b", "c")));
    ...
    assertFalse (CollectionEqualsHelper.equalsCollection (aArray, ArrayHelper.newArray ("a", "b")));
    assertFalse (CollectionEqualsHelper.equalsCollection (aArray, ArrayHelper.newArray ("A", "b", "c")));
    assertFalse (CollectionEqualsHelper.equalsCollection (aArray, ArrayHelper.newArray ("a", "B", "c")));
    assertFalse (CollectionEqualsHelper.equalsCollection (aArray, ArrayHelper.newArray ("a", "b", "C")));
    assertFalse (CollectionEqualsHelper.equalsCollection (aArray, ArrayHelper.newArray ("a", "b", "c", "d")));
  ...
  public void testArrayComplex ()
  {
    ...
    assertFalse (CollectionEqualsHelper.equalsCollection (aArray, new CommonsHashSet <> ("a", "b", "c")));
    assertFalse (CollectionEqualsHelper.equalsCollection (aArray, ArrayHelper.newArray ("a", "b", "c")));
    assertFalse (CollectionEqualsHelper.equalsCollection (aArray, ArrayHelper.newArray ("a", null, "c")));
  }
  ...
  public void testComplex ()
  {
    ...
    assertTrue (CollectionEqualsHelper.equalsCollection (aMap, CollectionHelper.newMap (aMap)));
  ...
  public void testIterator ()
  {
    ...
    assertFalse (CollectionEqualsHelper.equalsCollection (aCont.iterator (), ArrayHelper.newArray ("a", "b", "c")));
  }
  ...
  public void testEnumeration ()
  {
    ...
    assertTrue (CollectionEqualsHelper.equalsCollection (IteratorHelper.getEnumeration (new CommonsArrayList <> ()),
                                                         IteratorHelper.getEnumeration (new CommonsLinkedList <> ())));
    assertTrue (CollectionEqualsHelper.equalsCollection (IteratorHelper.getEnumeration (new NonBlockingStack <> ()),
                                                         IteratorHelper.getEnumeration (new CommonsVector <> ())));
    assertTrue (CollectionEqualsHelper.equalsCollection (IteratorHelper.getEnumeration (new NonBlockingStack <> ()),
                                                         IteratorHelper.getEnumeration (new Stack <> ())));

    assertFalse (CollectionEqualsHelper.equalsCollection (IteratorHelper.getEnumeration (aCont),
                                                          IteratorHelper.getEnumeration (new CommonsLinkedList <> ())));
    assertFalse (CollectionEqualsHelper.equalsCollection (IteratorHelper.getEnumeration (new CommonsLinkedList <> ()),
                                                          IteratorHelper.getEnumeration (aCont)));
    assertFalse (CollectionEqualsHelper.equalsCollection (IteratorHelper.getEnumeration (aCont),
    ...
    assertFalse (CollectionEqualsHelper.equalsCollection (IteratorHelper.getEnumeration (aCont),
                                                          IteratorHelper.getEnumeration (new CommonsArrayList <> ("a",
                                                                                                                  ...
                                                                                                                  "d"))));
    assertFalse (CollectionEqualsHelper.equalsCollection (IteratorHelper.getEnumeration (aCont),
                                                          IteratorHelper.getEnumeration (new StringMap ("a", "b").add (
                                                                                                                       "c",
                                                                                                                       "d"))));
    assertFalse (CollectionEqualsHelper.equalsCollection (IteratorHelper.getEnumeration (aCont),
