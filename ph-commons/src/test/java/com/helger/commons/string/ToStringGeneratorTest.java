...
public final class ToStringGeneratorTest
{
  ...
  public void testCommon ()
  {
    new ToStringGenerator (this).append ("boolean", true)
                                ...
                                .append ("double[]", new double [] { Double.MIN_VALUE,
                                                                     1,
                                                                     2,
                                                                     3.1415,
                                                                     Double.MAX_VALUE,
                                                                     ...
                                                                     Double.POSITIVE_INFINITY,
                                                                     Double.NEGATIVE_INFINITY })
                                .append ("float[]", new float [] { Float.MIN_VALUE,
                                                                   1,
                                                                   2,
                                                                   3.1415f,
                                                                   Float.MAX_VALUE,
                                ...
                                .appendIfNotNull ("char[]",
                                                  new char [] { Character.MIN_VALUE,
                                                                ...
                                                                'Z',
                                                                Character.MAX_VALUE })
                                .appendIfNotNull ("double[]", new double [] { Double.MIN_VALUE,
                                                                              1,
                                                                              2,
                                                                              3.1415,
                                                                              Double.MAX_VALUE,
                                                                              ...
                                                                              Double.POSITIVE_INFINITY,
                                                                              Double.NEGATIVE_INFINITY })
                                .appendIfNotNull ("float[]", new float [] { Float.MIN_VALUE,
                                                                            1,
                                                                            2,
                                                                            3.1415f,
                                                                            Float.MAX_VALUE,
