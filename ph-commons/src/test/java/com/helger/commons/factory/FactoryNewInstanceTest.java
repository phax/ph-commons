...
public final class FactoryNewInstanceTest
{
  ...
  public void testGetNewInstanceFactory ()
  {
    ...
    Supplier <?> aFactory = FactoryNewInstance.create (FactoryNewInstanceTest.class);
  ...
  {
    // test with a valid class
    final Supplier <?> aFactory = FactoryNewInstance.create (FactoryNewInstanceTest.class, true);
    assertNotNull (aFactory);
    assertNotNull (aFactory.get ());
  ...
  {
    TestHelper.testDefaultImplementationWithEqualContentObject (FactoryNewInstance.create (String.class),
                                                                       FactoryNewInstance.create (String.class));
    TestHelper.testDefaultImplementationWithDifferentContentObject (FactoryNewInstance.create (String.class),
