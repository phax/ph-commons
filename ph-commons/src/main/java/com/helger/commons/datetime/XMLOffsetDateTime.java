...
{
  /**
   * The minimum supported {@code XMLOffsetDateTime}, '-999999999-01-01T00:00:00+18:00'. This is the
  ...
  /**
   * The maximum supported {@code XMLOffsetDateTime}, '+999999999-12-31T23:59:59.999999999-18:00'.
   ...
   * {@link LocalDateTime#MAX} and {@link ZoneOffset#MIN}. This could be used by an application as a
   * "far future" date-time.
   */
  public static final XMLOffsetDateTime MAX = XMLOffsetDateTime.of (LocalDateTime.MAX, ZoneOffset.MIN);

  /**
   * Gets a comparator that compares two {@code XMLOffsetDateTime} instances based solely on the
   * instant.
   * <p>
  ...
  /**
   * Compares this {@code XMLOffsetDateTime} to another date-time. The comparison is based on the
   * instant.
   *
   * @param datetime1
   ...
   * <p>
   * This creates an offset date-time with the specified local date, time and no zone offset.
   *
   * @param date
  ...
  /**
   * Obtains an instance of {@code XMLOffsetDateTime} from a date, time and offset.
   * <p>
  ...
  /**
   * Obtains an instance of {@code XMLOffsetDateTime} from a year, month, day, hour, minute, second,
  ...
  /**
   * Obtains an instance of {@code XMLOffsetDateTime} from an {@code Instant} and zone ID.
   * <p>
   ...
   * instance of {@code XMLOffsetDateTime}.
   * <p>
   ...
   * result will be the combination of {@code ZoneOffset} with either with {@code LocalDateTime} or
   * {@code Instant}. Implementations are permitted to perform optimizations such as accessing those
   ...
   * to be used as a query via method reference, {@code XMLOffsetDateTime::from}.
   *
   * @param temporal
  ...
  {
    if (temporal instanceof final XMLOffsetDateTime aXODT)
      return aXODT;
   ...
   *
   * @param text
   *        the text to parse such as "2007-12-03T10:15:30+01:00", not <code>null</code>.
   * @return the parsed offset date-time, not <code>null</code>
  ...
  /**
   * Obtains an instance of {@code XMLOffsetDateTime} from a text string using a specific formatter.
   * <p>
   ...
   *
   * @param dateTime
   *        the local date-time, not <code>null</code>
   * @param offset
   ...
   * false, then calling the {@link #plus(long, TemporalUnit)} and {@link #minus(long, TemporalUnit)
  ...
  /**
   * Returns a copy of this {@code XMLOffsetDateTime} with the specified offset ensuring that the
   ...
   * will return {@code 2007-12-03T10:30+03:00}.
   * <p>
   ...
   * @return an {@code XMLOffsetDateTime} based on this date-time with the requested offset, not
   *         null
   */
  @Nonnull
   ...
   * <p>
   * This returns an {@code XMLOffsetDateTime}, based on this one, with the date-time adjusted. The
   ...
   * @return an {@code XMLOffsetDateTime} based on {@code this} with the adjustment made, not null
   * @throws DateTimeException
  ...
  public XMLOffsetDateTime with (@Nonnull final TemporalAdjuster adjuster)
  {
    ...
    if (adjuster instanceof final Instant aInst)
      return ofInstant (aInst, m_aOffset);

    if (adjuster instanceof final ZoneOffset aZO)
      return with (m_aDateTime, aZO);

    if (adjuster instanceof final XMLOffsetDateTime aXODT)
      return aXODT;
   ...
   * <p>
   * This returns an {@code XMLOffsetDateTime}, based on this one, with the value for the specified
   ...
   * @return an {@code XMLOffsetDateTime} based on {@code this} with the specified field set, not
   *         null
   * @throws DateTimeException
   ...
   * @return an {@code XMLOffsetDateTime} based on this date-time with the requested year, not null
   * @throws DateTimeException
  ...
  /**
   * Returns a copy of this {@code XMLOffsetDateTime} with the month-of-year altered.
   * <p>
   * The time and offset do not affect the calculation and will be the same in the result. If the
   * day-of-month is invalid for the year, it will be changed to the last valid day of the month.
   * <p>
   ...
   * @return an {@code XMLOffsetDateTime} based on this date-time with the requested month, not null
   * @throws DateTimeException
  ...
  /**
   * Returns a copy of this {@code XMLOffsetDateTime} with the day-of-month altered.
   * <p>
   * If the resulting {@code XMLOffsetDateTime} is invalid, an exception is thrown. The time and
   ...
   * @return an {@code XMLOffsetDateTime} based on this date-time with the requested day, not null
   * @throws DateTimeException
  ...
  /**
   * Returns a copy of this {@code XMLOffsetDateTime} with the day-of-year altered.
   * <p>
   * The time and offset do not affect the calculation and will be the same in the result. If the
   * resulting {@code XMLOffsetDateTime} is invalid, an exception is thrown.
   * <p>
   * This instance is immutable and unaffected by this method call.
   *
   * @param dayOfYear
   *        the day-of-year to set in the result, from 1 to 365-366
   * @return an {@code XMLOffsetDateTime} based on this date with the requested day, not null
   * @throws DateTimeException
   ...
   * @return an {@code XMLOffsetDateTime} based on this date-time with the requested hour, not null
   * @throws DateTimeException
  ...
  /**
   * Returns a copy of this {@code XMLOffsetDateTime} with the minute-of-hour altered.
   * <p>
   * The date and offset do not affect the calculation and will be the same in the result.
   * <p>
   * This instance is immutable and unaffected by this method call.
   ...
   * @return an {@code XMLOffsetDateTime} based on this date-time with the requested minute, not
   *         null
   * @throws DateTimeException
  ...
  /**
   * Returns a copy of this {@code XMLOffsetDateTime} with the second-of-minute altered.
   * <p>
   * The date and offset do not affect the calculation and will be the same in the result.
   * <p>
   * This instance is immutable and unaffected by this method call.
   ...
   * @return an {@code XMLOffsetDateTime} based on this date-time with the requested second, not
   *         null
   * @throws DateTimeException
  ...
  /**
   * Returns a copy of this {@code XMLOffsetDateTime} with the nano-of-second altered.
   * <p>
   * The date and offset do not affect the calculation and will be the same in the result.
   * <p>
   * This instance is immutable and unaffected by this method call.
   ...
   * @return an {@code XMLOffsetDateTime} based on this date-time with the requested nanosecond, not
   *         null
   * @throws DateTimeException
   ...
   * @return an {@code XMLOffsetDateTime} based on this date-time with the time truncated, not null
   * @throws DateTimeException
   ...
   * <p>
   * This returns an {@code XMLOffsetDateTime}, based on this one, with the specified amount added.
   ...
   * @return an {@code XMLOffsetDateTime} based on this date-time with the addition made, not null
   * @throws DateTimeException
   ...
   * Returns a copy of this date-time with the specified amount added.
   * <p>
   * This returns an {@code XMLOffsetDateTime}, based on this one, with the amount in terms of the
   ...
   * @return an {@code XMLOffsetDateTime} based on this date-time with the specified amount added,
   *         not null
   * @throws DateTimeException
   *         if the addition cannot be made
   * @throws UnsupportedTemporalTypeException
  ...
  /**
   * Returns a copy of this {@code XMLOffsetDateTime} with the specified number of years added.
   * <p>
   ...
   * @return an {@code XMLOffsetDateTime} based on this date-time with the years added, not null
   * @throws DateTimeException
   *         if the result exceeds the supported date range
   */
  @Nonnull
  ...
  /**
   * Returns a copy of this {@code XMLOffsetDateTime} with the specified number of months added.
   * <p>
   ...
   * @return an {@code XMLOffsetDateTime} based on this date-time with the months added, not null
   * @throws DateTimeException
   *         if the result exceeds the supported date range
   */
  @Nonnull
   ...
   * @return an {@code XMLOffsetDateTime} based on this date-time with the weeks added, not null
   * @throws DateTimeException
   *         if the result exceeds the supported date range
   */
  @Nonnull
   ...
   * @return an {@code XMLOffsetDateTime} based on this date-time with the days added, not null
   * @throws DateTimeException
   *         if the result exceeds the supported date range
   */
  @Nonnull
  ...
  /**
   * Returns a copy of this {@code XMLOffsetDateTime} with the specified number of hours added.
   * <p>
   * This instance is immutable and unaffected by this method call.
   *
   * @param hours
   *        the hours to add, may be negative
   * @return an {@code XMLOffsetDateTime} based on this date-time with the hours added, not null
   * @throws DateTimeException
   *         if the result exceeds the supported date range
   */
  @Nonnull
  ...
  /**
   * Returns a copy of this {@code XMLOffsetDateTime} with the specified number of minutes added.
   * <p>
   * This instance is immutable and unaffected by this method call.
   *
   * @param minutes
   *        the minutes to add, may be negative
   * @return an {@code XMLOffsetDateTime} based on this date-time with the minutes added, not null
   * @throws DateTimeException
   *         if the result exceeds the supported date range
   */
  @Nonnull
  ...
  /**
   * Returns a copy of this {@code XMLOffsetDateTime} with the specified number of seconds added.
   * <p>
   * This instance is immutable and unaffected by this method call.
   *
   * @param seconds
   *        the seconds to add, may be negative
   * @return an {@code XMLOffsetDateTime} based on this date-time with the seconds added, not null
   * @throws DateTimeException
   *         if the result exceeds the supported date range
   */
  @Nonnull
  ...
  /**
   * Returns a copy of this {@code XMLOffsetDateTime} with the specified number of nanoseconds
   * added.
   * <p>
   * This instance is immutable and unaffected by this method call.
   *
   ...
   * @return an {@code XMLOffsetDateTime} based on this date-time with the nanoseconds added, not
   *         null
   * @throws DateTimeException
   ...
   * <p>
   * This returns an {@code XMLOffsetDateTime}, based on this one, with the specified amount
   ...
   * @return an {@code XMLOffsetDateTime} based on this date-time with the subtraction made, not
   *         null
   * @throws DateTimeException
   ...
   * @return an {@code XMLOffsetDateTime} based on this date-time with the specified amount
   *         subtracted, not null
   * @throws DateTimeException
   *         if the subtraction cannot be made
   * @throws UnsupportedTemporalTypeException
  ...
  /**
   * Returns a copy of this {@code XMLOffsetDateTime} with the specified number of years subtracted.
   * <p>
   ...
   * @return an {@code XMLOffsetDateTime} based on this date-time with the years subtracted, not
   *         null
   * @throws DateTimeException
   *         if the result exceeds the supported date range
   */
  ...
  /**
   * Returns a copy of this {@code XMLOffsetDateTime} with the specified number of months
   * subtracted.
   * <p>
   ...
   * @return an {@code XMLOffsetDateTime} based on this date-time with the months subtracted, not
   *         null
   * @throws DateTimeException
   *         if the result exceeds the supported date range
   */
  ...
  /**
   * Returns a copy of this {@code XMLOffsetDateTime} with the specified number of weeks subtracted.
   * <p>
   ...
   * @return an {@code XMLOffsetDateTime} based on this date-time with the weeks subtracted, not
   *         null
   * @throws DateTimeException
   *         if the result exceeds the supported date range
   */
  ...
  /**
   * Returns a copy of this {@code XMLOffsetDateTime} with the specified number of days subtracted.
   * <p>
   ...
   * @return an {@code XMLOffsetDateTime} based on this date-time with the days subtracted, not null
   * @throws DateTimeException
   *         if the result exceeds the supported date range
   */
  @Nonnull
   ...
   * @return an {@code XMLOffsetDateTime} based on this date-time with the hours subtracted, not
   *         null
   * @throws DateTimeException
   *         if the result exceeds the supported date range
   */
  ...
  /**
   * Returns a copy of this {@code XMLOffsetDateTime} with the specified number of minutes
   * subtracted.
   * <p>
   * This instance is immutable and unaffected by this method call.
   *
   ...
   * @return an {@code XMLOffsetDateTime} based on this date-time with the minutes subtracted, not
   *         null
   * @throws DateTimeException
   *         if the result exceeds the supported date range
   */
  ...
  /**
   * Returns a copy of this {@code XMLOffsetDateTime} with the specified number of seconds
   * subtracted.
   * <p>
   * This instance is immutable and unaffected by this method call.
   *
   ...
   * @return an {@code XMLOffsetDateTime} based on this date-time with the seconds subtracted, not
   *         null
   * @throws DateTimeException
   *         if the result exceeds the supported date range
   */
   ...
   * @return an {@code XMLOffsetDateTime} based on this date-time with the nanoseconds subtracted,
   *         not null
   * @throws DateTimeException
   *         if the result exceeds the supported date range
   */
   ...
   * <p>
   * This calculates the amount of time between two {@code XMLOffsetDateTime} objects in terms of a
   * single {@code TemporalUnit}. The start and end points are {@code this} and the specified
   * date-time. The result will be negative if the end is before the start. For example, the amount
   * in days between two date-times can be calculated using
   * {@code startDateTime.until(endDateTime, DAYS)}.
   * <p>
   * The {@code Temporal} passed to this method is converted to a {@code XMLOffsetDateTime} using
   ...
   * {@code HALF_DAYS}, {@code DAYS}, {@code WEEKS}, {@code MONTHS}, {@code YEARS}, {@code DECADES},
   * {@code CENTURIES}, {@code MILLENNIA} and {@code ERAS} are supported. Other {@code ChronoUnit}
   ...
   *
   * @param endExclusive
   *        the end date, exclusive, which is converted to an {@code XMLOffsetDateTime}, not null
   * @param unit
   ...
   * used to determine the resultant local time and offset. This method uses
   * {@link ZonedDateTime#ofLocal(LocalDateTime, ZoneId, ZoneOffset)} to retain the offset from this
   ...
   * same instant, the local date-time is compared to distinguish them. This step is needed to make
   * the ordering consistent with {@code equals()}.
   *
   * @param other
   *        the other date-time to compare to, not null
   * @return the comparator value, negative if less, positive if greater
   ...
   * on the time-line, use {@link #isEqual}. Only objects of type {@code XMLOffsetDateTime} are
