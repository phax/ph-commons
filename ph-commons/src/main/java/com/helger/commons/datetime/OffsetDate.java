 ...
 * This class is originally from the ThreeTen-Extra project. It is included here to reduce
 * dependencies.
 * <p>
 ...
 * can be stored in an {@code OffsetDate}. <b>Implementation Requirements:</b> This class is
...
{
  /**
   * The minimum supported {@code OffsetDate}, '-999999999-01-01+18:00'. This is the minimum local
   * date in the maximum offset (larger offsets are earlier on the time-line). This combines
  ...
  /**
   * The maximum supported {@code OffsetDate}, '+999999999-12-31-18:00'. This is the maximum local
   * date in the minimum offset (larger negative offsets are later on the time-line). This combines
   * {@link LocalDate#MAX} and {@link ZoneOffset#MIN}. This could be used by an application as a
   * "far future" date.
   */
  ...
  /**
   * Obtains an instance of {@code OffsetDate} from a year, month, day and offset.
   * <p>
   ...
   * converts the arbitrary temporal object to an instance of {@code OffsetDate}.
   * <p>
   ...
   * to be used in queries via method reference, {@code OffsetDate::from}.
   *
   * @param temporal
  ...
  {
    if (temporal instanceof final OffsetDate aOD)
      return aOD;
  ...
  /**
   * Returns a copy of this {@code OffsetDate} with the specified offset ensuring that the result
   ...
   * <p>
   * This returns an {@code OffsetDate} based on this one, with the date adjusted. The adjustment
   ...
   * <p>
   * This returns an {@code OffsetDate} based on this one, with the value for the specified field
   ...
   * <p>
   * This returns an {@code OffsetDate} based on this one, with the specified amount added. The
   ...
   * <p>
   * This returns an {@code OffsetDate} based on this one, with the amount in terms of the unit
   ...
   * <p>
   * This returns am {@code OffsetDate} based on this one, with the specified amount subtracted. The
   * amount is typically {@link Period} but may be any other type implementing the
   * {@link TemporalAmount} interface.
   * <p>
   ...
   * <p>
   * The {@code Temporal} passed to this method is converted to a {@code OffsetDate} using
   ...
   *
   * @param endExclusive
   *        the end time, exclusive, which is converted to an {@code OffsetDate}, not null
   * @param unit
  ...
  /**
   * Converts this {@code OffsetDate} to the number of seconds since the epoch of
  ...
  // -----------------------------------------------------------------------
  /**
   * Checks if the instant of midnight at the start of this {@code OffsetDate} is after midnight at
  ...
  /**
   * Checks if the instant of midnight at the start of this {@code OffsetDate} is before midnight at
   * the start of the specified date.
   * <p>
   * This method differs from the comparison in {@link #compareTo} in that it only compares the
   * instant of the date. This is equivalent to using
  ...
  /**
   * Checks if the instant of midnight at the start of this {@code OffsetDate} equals midnight at
   * the start of the specified date.
   * <p>
   ...
   * the time-line, use {@link #isEqual(OffsetDate)}.
   * <p>
   * Only objects of type {@code OffsetDate} are compared, other types return false. To compare the
   * underlying local date of two {@code TemporalAccessor} instances, use
   * {@link ChronoField#EPOCH_DAY} as a comparator.
   *
   * @param o
