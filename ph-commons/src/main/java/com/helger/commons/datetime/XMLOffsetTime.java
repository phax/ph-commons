...
{
  /**
   * The minimum supported {@code XMLOffsetTime}, '00:00:00+18:00'. This is the time of midnight at
  ...
  /**
   * The maximum supported {@code XMLOffsetTime}, '23:59:59.999999999-18:00'. This is the time just
  ...
  /**
   * Obtains an instance of {@code XMLOffsetTime} from a local time and no offset.
   *
   * @param time
  ...
  /**
   * Obtains an instance of {@code XMLOffsetTime} from a local time and an offset.
   *
   * @param time
   *        the local time, not null
   * @param offset
  ...
  /**
   * Obtains an instance of {@code XMLOffsetTime} from an hour, minute, second and nanosecond.
   * <p>
  ...
  /**
   * Obtains an instance of {@code XMLOffsetTime} from an {@code Instant} and zone ID.
   * <p>
   ...
   * instance of {@code XMLOffsetTime}.
   * <p>
   * The conversion extracts and combines the {@code ZoneOffset} and the {@code LocalTime} from the
   * temporal object. Implementations are permitted to perform optimizations such as accessing those
   ...
   * to be used as a query via method reference, {@code XMLOffsetTime::from}.
   *
   * @param temporal
  ...
  /**
   * Obtains an instance of {@code XMLOffsetTime} from a text string such as {@code 10:15:30+01:00}.
   * <p>
  ...
  /**
   * Obtains an instance of {@code XMLOffsetTime} from a text string using a specific formatter.
   * <p>
   ...
   * <p>
   * This checks if the specified unit can be added to, or subtracted from, this offset-time. If
   ...
   * <p>
   * This queries this time for the value of the specified field. The returned value will always be
  ...
  /**
   * Returns a copy of this {@code XMLOffsetTime} with the specified offset ensuring that the result
   * has the same local time.
   * <p>
   * This method returns an object with the same {@code LocalTime} and the specified
   * {@code ZoneOffset}. No calculation is needed or performed. For example, if this time represents
   * {@code 10:30+02:00} and the offset specified is {@code +03:00}, then this method will return
   * {@code 10:30+03:00}.
   * <p>
  ...
  /**
   * Returns a copy of this {@code XMLOffsetTime} with the specified offset ensuring that the result
   * is at the same instant on an implied day.
   * <p>
   * This method returns an object with the specified {@code ZoneOffset} and a {@code LocalTime}
   * adjusted by the difference between the two offsets. This will result in the old and new objects
   * representing the same instant on an implied day. This is useful for finding the local time in a
   ...
   * <p>
   * This returns an {@code XMLOffsetTime}, based on this one, with the time adjusted. The
   ...
   * @return an {@code XMLOffsetTime} based on {@code this} with the adjustment made, not null
   * @throws DateTimeException
  ...
  public XMLOffsetTime with (@Nonnull final TemporalAdjuster adjuster)
  {
    ...
    if (adjuster instanceof final LocalTime aLT)
      return with (aLT, m_aOffset);
    if (adjuster instanceof final ZoneOffset aZO)
      return with (m_aTime, aZO);
    if (adjuster instanceof final XMLOffsetTime aXOT)
      return aXOT;
   ...
   * <p>
   * This returns an {@code XMLOffsetTime}, based on this one, with the value for the specified
   ...
   * @return an {@code XMLOffsetTime} based on {@code this} with the specified field set, not null
   * @throws DateTimeException
   ...
   * @return an {@code XMLOffsetTime} based on this time with the requested hour, not null
   * @throws DateTimeException
  ...
  /**
   * Returns a copy of this {@code XMLOffsetTime} with the minute-of-hour altered.
   * <p>
   * The offset does not affect the calculation and will be the same in the result.
   * <p>
   * This instance is immutable and unaffected by this method call.
   ...
   * @return an {@code XMLOffsetTime} based on this time with the requested minute, not null
   * @throws DateTimeException
  ...
  /**
   * Returns a copy of this {@code XMLOffsetTime} with the second-of-minute altered.
   * <p>
   * The offset does not affect the calculation and will be the same in the result.
   * <p>
   * This instance is immutable and unaffected by this method call.
   ...
   * @return an {@code XMLOffsetTime} based on this time with the requested second, not null
   * @throws DateTimeException
  ...
  /**
   * Returns a copy of this {@code XMLOffsetTime} with the nano-of-second altered.
   * <p>
   * The offset does not affect the calculation and will be the same in the result.
   * <p>
   * This instance is immutable and unaffected by this method call.
   ...
   * @return an {@code XMLOffsetTime} based on this time with the requested nanosecond, not null
   * @throws DateTimeException
   ...
   * @return an {@code XMLOffsetTime} based on this time with the time truncated, not null
   * @throws DateTimeException
   ...
   * <p>
   * This returns an {@code XMLOffsetTime}, based on this one, with the specified amount added. The
   ...
   * @return an {@code XMLOffsetTime} based on this time with the addition made, not null
   * @throws DateTimeException
   ...
   * Returns a copy of this time with the specified amount added.
   * <p>
   * This returns an {@code XMLOffsetTime}, based on this one, with the amount in terms of the unit
   * added. If it is not possible to add the amount, because the unit is not supported or for some
   * other reason, an exception is thrown.
   * <p>
   * If the field is a {@link ChronoUnit} then the addition is implemented by
   * {@link LocalTime#plus(long, TemporalUnit)}. The offset is not part of the calculation and will
   ...
   * @return an {@code XMLOffsetTime} based on this time with the specified amount added, not null
   * @throws DateTimeException
   *         if the addition cannot be made
   * @throws UnsupportedTemporalTypeException
   *         if the unit is not supported
  ...
  /**
   * Returns a copy of this {@code XMLOffsetTime} with the specified number of hours added.
   * <p>
  ...
  /**
   * Returns a copy of this {@code XMLOffsetTime} with the specified number of minutes added.
   * <p>
  ...
  /**
   * Returns a copy of this {@code XMLOffsetTime} with the specified number of seconds added.
   * <p>
  ...
  /**
   * Returns a copy of this {@code XMLOffsetTime} with the specified number of nanoseconds added.
   * <p>
   ...
   * <p>
   * This returns an {@code XMLOffsetTime}, based on this one, with the specified amount subtracted.
   ...
   * @return an {@code XMLOffsetTime} based on this time with the subtraction made, not null
   * @throws DateTimeException
   ...
   * @return an {@code XMLOffsetTime} based on this time with the specified amount subtracted, not
   *         null
   * @throws DateTimeException
   *         if the subtraction cannot be made
   * @throws UnsupportedTemporalTypeException
  ...
  /**
   * Returns a copy of this {@code XMLOffsetTime} with the specified number of hours subtracted.
   * <p>
  ...
  /**
   * Returns a copy of this {@code XMLOffsetTime} with the specified number of minutes subtracted.
   * <p>
  ...
  /**
   * Returns a copy of this {@code XMLOffsetTime} with the specified number of seconds subtracted.
   * <p>
  ...
  /**
   * Returns a copy of this {@code XMLOffsetTime} with the specified number of nanoseconds
   * subtracted.
   * <p>
   ...
   * <p>
   * This calculates the amount of time between two {@code XMLOffsetTime} objects in terms of a
   * single {@code TemporalUnit}. The start and end points are {@code this} and the specified time.
   * The result will be negative if the end is before the start. For example, the amount in hours
   * between two times can be calculated using {@code startTime.until(endTime, HOURS)}.
   * <p>
   * The {@code Temporal} passed to this method is converted to a {@code XMLOffsetTime} using
   ...
   * two times. For example, the amount in hours between 11:30Z and 13:29Z will only be one hour as
   ...
   *
   * @param endExclusive
   *        the end time, exclusive, which is converted to an {@code XMLOffsetTime}, not null
   * @param unit
   ...
   * same instant, the local time is compared to distinguish them. This step is needed to make the
   * ordering consistent with {@code equals()}.
   * <p>
   * To compare the underlying local time of two {@code TemporalAccessor} instances, use
  ...
  /**
   * Checks if the instant of this {@code XMLOffsetTime} is after that of the specified time
  ...
  /**
   * Checks if the instant of this {@code XMLOffsetTime} is before that of the specified time
   * applying both times to a common date.
   * <p>
   * This method differs from the comparison in {@link #compareTo} in that it only compares the
   * instant of the time. This is equivalent to converting both times to an instant using the same
  ...
  /**
   * Checks if the instant of this {@code XMLOffsetTime} is equal to that of the specified time
   * applying both times to a common date.
   * <p>
   ...
   * the time-line, use {@link #isEqual(XMLOffsetTime)}.
   * <p>
   * Only objects of type {@code XMLOffsetTime} are compared, other types return false. To compare
   * the underlying local time of two {@code TemporalAccessor} instances, use
   * {@link ChronoField#NANO_OF_DAY} as a comparator.
   *
   * @param o
