...
public enum ELicense implements ILicense
{
  ...
  MPL20 ("mpl20", "Mozilla Public License Version 2.0", new Version (2, 0), "https://www.mozilla.org/MPL/2.0/"),
  // BSD/MIT
  ...
  FDL11 ("fdl11",
         ...
         new Version (1, 1),
         "https://www.gnu.org/licenses/old-licenses/fdl-1.1"),
  FDL12 ("fdl12",
         "GNU Free Documentation License",
         new Version (1, 2),
  ...
  // Creative commons
  CCBY10 ("ccby10",
          "Creative Commons Attributation",
          new Version (1, 0),
