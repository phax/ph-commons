 ...
 */
@NotThreadSafe
public class CollatingComparatorLocaleDisplayLanguageInLocale extends CollatingPartComparator <Locale>
{
  ...
  {
    super (aSortLocale, aObject -> aObject.getDisplayLanguage (aContentLocale));
