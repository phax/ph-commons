 ...
 */
@NotThreadSafe
public abstract class AbstractPartComparator2 <DATATYPE, PARTTYPE> extends AbstractComparator <DATATYPE>
{
   ...
   */
  public AbstractPartComparator2 (@Nonnull final Comparator <? super PARTTYPE> aPartComparator,
