...
public class ComparatorStringShortestFirst extends AbstractComparator <String>
{
  ...
  public ComparatorStringShortestFirst (@Nullable final Comparator <? super String> aContentComparator)
  {
  ...
  protected int mainCompare (@Nonnull final String sElement1, @Nonnull final String sElement2)
  {
    ...
    int ret = CompareHelper.compare (sElement1.length (), sElement2.length ());
    if (ret == 0)
    {
