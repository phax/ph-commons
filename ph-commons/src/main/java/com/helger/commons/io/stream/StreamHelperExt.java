...
public final class StreamHelperExt extends StreamHelper
{
  ...
  private static final IMutableStatisticsHandlerSize STATS_COPY_BYTES = StatisticsManager.getSizeHandler (StreamHelperExt.class.getName () +
                                                                                                          "$COPY");
  private static final IMutableStatisticsHandlerSize STATS_COPY_CHARS = StatisticsManager.getSizeHandler (StreamHelperExt.class.getName () +
                                                                                                          "$COPYCHARS");
