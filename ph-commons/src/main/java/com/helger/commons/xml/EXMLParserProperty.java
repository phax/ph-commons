...
public enum EXMLParserProperty implements IHasName
{
  ...
  * Xerces: This property is currently not supported because the contents of the
  ...
  * documents: e.g, "http://www.example.com file_name.xsd". The user can specify
  ...
  * element declaration regardless of the actual name of the root element in the
  * instance document. If the value is a QName and a element declaration cannot
  * be found an error will be reported.<br>
  ...
  * processing of substitution groups, xsi:type and wildcards may fail to locate
  ...
  * a value larger than 16K. For really tiny documents (1K, for example), you
  * can also set it to a value less than 2K, to get the best performance.<br>
  ...
  * default document factory, the deferred node expansion feature does not work.
  */
