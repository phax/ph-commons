...
public interface IGetterByIndexTrait
{
   ...
   * @return The value at the specified index. No <code>null</code> constraints applicable.
   */
  @Nullable
  ...
  /**
   * Implement this method to handle cases of {@link #getSafeCastedValue(int, Object, Class)} that
   * failed because invalid provided class.
   *
   * <pre>
