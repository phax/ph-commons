...
/**
 * A special namespace prefix mapper for the Oracle runtime JAXB2
 * implementation.<br>
 * Important note: this class works only, if the com.sun.xml.bind:jaxb-impl
 * artifact is NOT in your classpath, because this class extends
 * <code>com.sun.xml.internal.bind.marshaller.NamespacePrefixMapper</code> which
 * is not available in the external JAXB, where the class is called
 * <code>com.sun.xml.bind.marshaller.NamespacePrefixMapper</code>
 *
...
public class JAXBNamespacePrefixMapperOracleRT extends NamespacePrefixMapper
{
  ...
  public JAXBNamespacePrefixMapperOracleRT (@Nonnull final NamespaceContext aNC)
  {
