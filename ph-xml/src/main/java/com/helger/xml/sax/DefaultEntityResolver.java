 ...
 * re-enabled. The default parser configuration in {@link com.helger.xml.XMLFactory} disallows
 * DOCTYPE declarations and external entities, so this resolver is not invoked for external entities
