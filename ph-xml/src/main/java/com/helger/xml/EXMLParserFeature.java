...
{
  /**
   * When true: instructs the implementation to process XML securely. This may set limits on XML
   * constructs to avoid conditions such as denial of service attacks.<br>
   * When false: instructs the implementation to process XML according the letter of the XML
   * specifications ignoring security issues such as limits on XML constructs to avoid conditions
   * such as denial of service attacks.<br>
   * Default: false<br>
  ...
  /**
   * When true: The methods of the org.xml.sax.ext.EntityResolver2 interface will be used when an
   * object implementing this interface is registered with the parser using setEntityResolver.<br>
   * When false: The methods of the org.xml.sax.ext.EntityResolver2 interface will not be used.<br>
   * Default: true<br>
  ...
  /**
   * When true: The parser will validate the document only if a grammar is specified.<br>
   * When false: Validation is determined by the state of the {@link #VALIDATION} feature.<br>
   * Default: false<br>
  ...
  /**
   * When true: Turn on XML Schema validation by inserting an XML Schema validator into the
   * pipeline.<br>
  ...
  /**
   * When true: Enable full schema grammar constraint checking, including checking which may be
   * time-consuming or memory intensive. Currently, unique particle attribution constraint checking
   * and particle derivation restriction checking are controlled by this option.<br>
  ...
  /**
   * When true: Expose via SAX and DOM XML Schema normalized values for attributes and elements.<br>
   * When false: Expose the infoset values<br>
   * Default: true<br>
   * XML Schema normalized values will be exposed only if both {@link #SCHEMA} and
   * {@link #VALIDATION} features are set to true.<br>
  ...
  /**
   * When true: xsi:type attributes will be ignored until a global element declaration has been
   * found, at which point xsi:type attributes will be processed on the element for which the global
   * element declaration was found as well as its descendants.<br>
  ...
  /**
   * When true: Enable generation of synthetic annotations. A synthetic annotation will be generated
   * when a schema component has non-schema attributes but no child annotation.<br>
  ...
  /**
   * When true: Schema annotations will be laxly validated against available schema components.<br>
  ...
  /**
   * When true: All schema location hints will be used to locate the components for a given target
   * namespace.<br>
   * When false: Only the first schema location hint encountered by the processor will be used to
   * locate the components for a given target namespace.<br>
   * Default: false<br>
   ...
   * https://www.owasp.org/index.php/XML_External_Entity_%28XXE%29_Processing <br>
   * (http://xml.org/sax/features/external-general-entities)
   */
  EXTERNAL_GENERAL_ENTITIES (EXMLParserFeatureType.GENERAL, "http://xml.org/sax/features/external-general-entities"),

  /**
   * When true: Include external parameter entities and the external DTD subset. <br>
   * When false: Do not include external parameter entities or the external DTD subset.<br>
   * Default: true<br>
   * Note: set to false to avoid XXE -
   * https://www.owasp.org/index.php/XML_External_Entity_%28XXE%29_Processing <br>
  ...
  /**
   * When true: Construct an optimal representation for DTD content models to significantly reduce
   * the likelihood a StackOverflowError will occur when large content models are processed.<br>
   * When false: Do not invest processing time to construct an optimal representation for DTD
   * content models.<br>
   * Default: false<br>
   ...
   * When false: Disable checking of ID/IDREF constraints. Validation will not fail if there are
   * non-unique ID values or dangling IDREF values in the document.<br>
   * Default: true<br>
  ...
  /**
   * When true: Check that each value of type ENTITY matches the name of an unparsed entity declared
   * in the DTD.<br>
   * When false: Do not check that each value of type ENTITY matches the name of an unparsed entity
   * declared in the DTD.<br>
   * Default: true<br>
   ...
   * When false: Do not report a warning when a duplicate attribute is re-declared.<br>
   * Default: false<br>
  ...
  /**
   * When true: Report a warning if an element referenced in a content model is not declared.<br>
   * When false: Do not report a warning if an element referenced in a content model is not
   * declared.<br>
   * Default: false<br>
   ...
   * When false: Do not allow Java encoding names in XMLDecl and TextDecl line. <br>
   * Default: false<br>
  ...
  /**
   * When true: Load the DTD and use it to add default attributes and set attribute types when
   * parsing.<br>
   * When false: Build the grammar but do not use the default attributes and attribute types
  ...
  /**
   * When true: Notifies the handler of character reference boundaries in the document via the
   * start/endEntity callbacks.<br>
  ...
  /**
   * When true: Notifies the handler of built-in entity boundaries (e.g &amp;) in the document via
   * the start/endEntity callbacks.<br>
  ...
  /**
   * When true: A fatal error is thrown if the incoming document contains a DOCTYPE declaration.<br>
  ...
  /**
   * When true: Requires that a URI has to be provided where a URI is expected. <br>
   * When false: Some invalid URI's are accepted as valid values when a URI is expected. Examples
   * include: using platform dependent file separator in place of '/'; using Windows/DOS path names
   * like "c:\blah" and "\\host\dir\blah"; using invalid URI characters (space, for example)<br>
   * Default: false<br>
  ...
  /**
   * When true: Perform base URI fixup as specified by the XInclude Recommendation.<br>
   * When false: Do not perform base URI fixup. The XInclude processor will not add xml:base
   * attributes.<br>
   * Default: true<br>
  ...
  /**
   * When true: Perform language fixup as specified by the XInclude Recommendation.<br>
   * When false: Do not perform language fixup. The XInclude processor will not add xml:lang
   * attributes.<br>
   * Default: true<br>
   ...
   * Default: true - In the LSParser implementation the default value of this feature is false.<br>
   * (http://apache.org/xml/features/dom/defer-node-expansion)
   */
  DOM_DEFER_NODE_EXPANSION (EXMLParserFeatureType.DOM, "http://apache.org/xml/features/dom/defer-node-expansion"),

  /**
   * When true: Create EntityReference nodes in the DOM tree. The EntityReference nodes and their
   * child nodes will be read-only.<br>
   * When false: Do not create EntityReference nodes in the DOM tree. No EntityReference nodes will
   * be created, only the nodes corresponding to their fully expanded substitution text will be
   * created.<br>
   * Default: true<br>
  ...
  /**
   * When true: Include text nodes that can be considered "ignorable whitespace" in the DOM
   * tree.<br>
  ...
  /**
   * When true: Report the original prefixed names and attributes used for namespace
   * declarations.<br>
   * When false: Do not report attributes used for Namespace declarations, and optionally do not
   * report original prefixed names.<br>
   * Default: false<br>
  ...
  /**
   * When true: All element names, prefixes, attribute names, namespace URIs, and local names are
   * internalized using the java.lang.String#intern(String):String method.<br>
  ...
  /**
   * When true: Report the beginning and end of parameter entities to a registered
   * LexicalHandler.<br>
   * When false: Do not report the beginning and end of parameter entities to a registered
   * LexicalHandler.<br>
   * Default: true<br>
  ...
  /**
   * When true: The document specified standalone="yes" in its XML declaration. <br>
   * When false: The document specified standalone="no" in its XML declaration or the standalone
   * document declaration was absent.<br>
   * Read-only!<br>
  ...
  /**
   * When true: The system identifiers passed to the notationDecl, unparsedEntityDecl, and
   * externalEntityDecl events will be absolutized relative to their base URIs before reporting.<br>
   * When false: System identifiers in declarations will not be absolutized before reporting.<br>
   * Default: true<br>
  ...
  /**
   * When true: Perform Unicode normalization checking (as described in section 2.13 and Appendix B
   * of the XML 1.1 Recommendation) and report normalization errors.<br>
   ...
   * interface.<br>
   * When false: The Attributes objects passed by the parser do not implement the
   ...
   * so the value of this feature will always be true.<br>
   ...
   * Read-only!<br>
   * Xerces-J will always report Locator objects that also implement org.xml.sax.ext.Locator2 so the
   * value of this feature will always be true. <br>
   * (http://xml.org/sax/features/use-locator2)
   */
  SAX_USE_LOCATOR2 (EXMLParserFeatureType.SAX, "http://xml.org/sax/features/use-locator2"),

  /**
   * When true: When the namespace-prefixes feature is set to true, namespace declaration attributes
   * will be reported as being in the http://www.w3.org/2000/xmlns/ namespace.<br>
   * When false: Namespace declaration attributes are reported as having no namespace.<br>
   * Default: false<br>
