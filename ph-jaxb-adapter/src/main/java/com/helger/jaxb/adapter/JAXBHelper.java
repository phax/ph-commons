...
public final class JAXBHelper
{
  ...
  /**
   * Get the hashcode of a List of arbitrary Objects.<br>
   * This method is used in the code generated by the ph-jaxb-plugin!
   *
   * @param aObj1
   *        List of Objects to get the hashcode from. May be <code>null</code>.
   * @return the hashcode
   * @since v12.0.0
   */
  ...
  /**
   * Get a deep clone of a JAXB element.<br>
   * This method is used in the code generated by the ph-jaxb-plugin!
   *
   * @param aObj
   *        The JAXB element to clone. May be <code>null</code>.
   * @param <DATATYPE>
   *        The value type of the JAXB element.
   * @return <code>null</code> if the input is <code>null</code>, a deep clone otherwise.
   * @since v12.0.0
   */
  @Nullable
