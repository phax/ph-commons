...
public final class PDTDisplayHelperTest
{
  ...
  public void testGetPeriodTextNumericEN ()
  {
    ...
    assertEquals ("1 month, 0 days, 0 hours, 0 minutes and 2 seconds",
                  PDTDisplayHelper.getPeriodText (0, 1, 0, 0, 0, 2, aTP));
    assertEquals ("1 year, 0 months, 0 days, 0 hours, 0 minutes and 2 seconds",
                  PDTDisplayHelper.getPeriodText (1, 0, 0, 0, 0, 2, aTP));
    assertEquals ("1 year, 2 months, 3 days, 4 hours, 5 minutes and 6 seconds",
                  PDTDisplayHelper.getPeriodText (1, 2, 3, 4, 5, 6, aTP));
    assertEquals ("2 years, 2 months, 3 days, 4 hours, 5 minutes and 6 seconds",
                  PDTDisplayHelper.getPeriodText (2, 2, 3, 4, 5, 6, aTP));
  }
  ...
  public void testGetPeriodTextNumericDE ()
  {
    ...
    assertEquals ("1 Monat, 0 Tage, 0 Stunden, 0 Minuten und 2 Sekunden",
                  PDTDisplayHelper.getPeriodText (0, 1, 0, 0, 0, 2, aTP));
    assertEquals ("1 Jahr, 0 Monate, 0 Tage, 0 Stunden, 0 Minuten und 2 Sekunden",
                  PDTDisplayHelper.getPeriodText (1, 0, 0, 0, 0, 2, aTP));
    assertEquals ("1 Jahr, 2 Monate, 3 Tage, 4 Stunden, 5 Minuten und 6 Sekunden",
                  PDTDisplayHelper.getPeriodText (1, 2, 3, 4, 5, 6, aTP));
    assertEquals ("2 Jahre, 2 Monate, 3 Tage, 4 Stunden, 5 Minuten und 6 Sekunden",
                  PDTDisplayHelper.getPeriodText (2, 2, 3, 4, 5, 6, aTP));
  }
  ...
  public void testGetPeriodTextLocalDateTime ()
  {
    ...
    assertEquals ("15 minutes and 12 seconds",
                  PDTDisplayHelper.getPeriodTextEN (PDTFactory.createLocalDateTime (2019,
                                                                                    Month.DECEMBER,
                                                                                    31,
                                                                                    8,
                                                                                    44,
    ...
    assertEquals ("2 hours, 0 minutes and 0 seconds",
                  PDTDisplayHelper.getPeriodTextEN (PDTFactory.createLocalDateTime (2019, Month.DECEMBER, 31, 7, 0, 0),
                                                    aLDT));
    assertEquals ("12 hours, 0 minutes and 0 seconds",
                  PDTDisplayHelper.getPeriodTextEN (PDTFactory.createLocalDateTime (2019, Month.DECEMBER, 30, 21, 0, 0),
                                                    aLDT));
    assertEquals ("1 day, 12 hours, 0 minutes and 0 seconds",
                  PDTDisplayHelper.getPeriodTextEN (PDTFactory.createLocalDateTime (2019, Month.DECEMBER, 29, 21, 0, 0),
                                                    aLDT));
    assertEquals ("2 days, 12 hours, 0 minutes and 0 seconds",
                  PDTDisplayHelper.getPeriodTextEN (PDTFactory.createLocalDateTime (2019, Month.DECEMBER, 28, 21, 0, 0),
                                                    aLDT));
    assertEquals ("1 month, 0 days, 12 hours, 0 minutes and 0 seconds",
                  PDTDisplayHelper.getPeriodTextEN (PDTFactory.createLocalDateTime (2019, Month.NOVEMBER, 30, 21, 0, 0),
                                                    aLDT));
    assertEquals ("1 year, 0 months, 0 days, 12 hours, 0 minutes and 0 seconds",
                  PDTDisplayHelper.getPeriodTextEN (PDTFactory.createLocalDateTime (2018, Month.DECEMBER, 30, 21, 0, 0),
                                                    aLDT));
    assertEquals ("1 year, 0 months, 0 days, 0 hours, 0 minutes and 0 seconds",
                  PDTDisplayHelper.getPeriodTextEN (PDTFactory.createLocalDateTime (2018, Month.DECEMBER, 31, 9, 0, 0),
                                                    aLDT));
    assertEquals ("1 year, 5 months, 25 days, 0 hours, 15 minutes and 13 seconds",
                  PDTDisplayHelper.getPeriodTextEN (PDTFactory.createLocalDateTime (2018, Month.JULY, 6, 8, 44, 47),
                                                    aLDT));

    assertEquals ("-3 hours, 0 minutes and 0 seconds",
                  PDTDisplayHelper.getPeriodTextEN (PDTFactory.createLocalDateTime (2019, Month.DECEMBER, 31, 12, 0, 0),
                                                    aLDT));
    assertEquals ("-1 day, -3 hours, 0 minutes and 0 seconds",
                  PDTDisplayHelper.getPeriodTextEN (PDTFactory.createLocalDateTime (2020, Month.JANUARY, 1, 12, 0, 0),
                                                    aLDT));
  }

  @Test
  public void testGetPeriodTextLocalDateTime2 ()
  {
    // Source: https://github.com/phax/phoss-smp/issues/383
    final LocalDateTime aFrom = PDTFactory.createLocalDateTime (2025, Month.OCTOBER, 3, 16, 46, 55);
