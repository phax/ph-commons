...
public final class PDTFormatPatternsTest
{
  ...
  public void testGetPattern ()
  {
    ...
    {
      // get pattern
      String sDefault = PDTFormatPatterns.getDefaultPatternDate (aLocale);
      String sShort = PDTFormatPatterns.getShortPatternDate (aLocale);
      String sMedium = PDTFormatPatterns.getMediumPatternDate (aLocale);
      String sLong = PDTFormatPatterns.getLongPatternDate (aLocale);
      String sFull = PDTFormatPatterns.getFullPatternDate (aLocale);
