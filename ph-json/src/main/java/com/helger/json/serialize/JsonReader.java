 ...
 * reads full Json declarations only.
 *
...
public final class JsonReader
{
  ...
  /**
   * @return The default Json parse exception handler. May not be <code>null</code>. For backwards
   *         compatibility reasons this is be default an instance of
   *         {@link LoggingJsonParseExceptionCallback}.
   */
  @Nonnull
   ...
   *
   * @param aReader
   *        The reader to read from. Should be buffered. May not be <code>null</code>.
  ...
  {
    return parseJson (aReader, aParserHandler, (IJsonParserSettings) null, (IJsonParseExceptionCallback) null);
  }

  /**
   * Generic JSON parse method. Usually this is not to be called manually - call this only when you
   ...
   * @param aParserHandler
   *        The parser handler. May not be <code>null</code>.
   * @param aParserSettings
   *        Optional JSON parser settings. May be <code>null</code>.
  ...
  public static ESuccess parseJson (@Nonnull @WillClose final Reader aReader,
                                    @Nonnull final IJsonParserHandler aParserHandler,
                                    @Nullable final IJsonParserSettings aParserSettings,
                                    @Nullable final IJsonParseExceptionCallback aCustomExceptionCallback)
  {
    ...
    try
    {
      ...
      if (aParserSettings != null)
        aParser.jsonParserSettings ().assignFrom (aParserSettings);
      aParser.parse ();
   ...
   * @param aReader
   *        The reader to read from. Should be buffered. May not be <code>null</code>.
   * @return {@link EValidity#VALID} if the JSON is valid, {@link EValidity#INVALID} otherwise.
   */
  @Nonnull
   ...
   *         exception handler is used), or <code>null</code> if a recoverable error occurred or
                                ...
                                @Nullable final IJsonParseExceptionCallback aCustomExceptionCallback)
  {
    ...
    if (parseJson (aReader, aHandler, aParserSettings, aCustomExceptionCallback).isFailure ())
      return null;
    return aHandler.getJson ();
  }

  /**
   * Read the Json from the passed String using a character stream. An eventually contained
   * <code>@charset</code> rule is ignored.
   *
   * @param sJson
   *        The source string containing the Json to be parsed. May not be <code>null</code>.
   * @return <code>null</code> if reading failed, the Json declarations otherwise.
   */
  @Nullable
  ...
  /**
   * @return Create a new {@link JsonBuilder} instance that is configured to read multiple
   *         instances. Never <code>null</code>. Use {@link JsonBuilder#source(Reader)} to ensure
   *         this works. When using {@link InputStream} or the like, there is too much pre read.
   * @since 9.3.8
   */
  @Nonnull
  public static JsonBuilder builderMultiObject ()
  {
    return builder ().dontCloseSource (true).useBufferedReader (false).checkForEOI (false);
  }

  /**
   * Factory for JSon reader for different sources. Use {@link #isValidJson()} to check if the JSON
   * is syntactically correct and {@link #read()} or {@link #readAsArray()} or
   * {@link #readAsObject()} or {@link #readAsValue()} to convert it to a parsed object.
   *
   * @author Philip Helger
   * @since 9.3.3
   */
  public static class JsonBuilder implements AutoCloseable
  {
    ...
    /**
     * Set avoid closing the source stream. This may be helpful when reading multiple objects.
    ...
    /**
     * Use a buffered reader or not. If you want to read multiple instances from a simple
     * {@link InputStream} this should be set to <code>false</code>. Default is <code>true</code>.
     *
     * @param bUseBufferedReader
     *        <code>true</code> to use it, <code>false</code> to use a non-buffered reader.
     * @return this for chaining
     * @since 9.3.8
     */
    @Nonnull
     ...
     *
     * @param aFile
     *        The File containing the JSON to be parsed. May not be <code>null</code>.
     * @return this for chaining
     */
    @Nonnull
     ...
     *
     * @param aBytes
     *        The byte array containing the JSON to be parsed. May not be <code>null</code>.
     * @return this for chaining
     * @since 9.3.4
     */
    @Nonnull
    ...
    /**
     * Use an InputStream provider as JSON source. Assumes UTF-8 as fallback charset.
     *
     * @param aISP
    ...
    /**
     * Use an InputStream provider as JSON source with a custom fallback charset.
     *
     * @param aISP
     *        The InputStream provider to be used. May not be <code>null</code>.
     * @param aFallbackCharset
    ...
    /**
     * Use an {@link InputStream} as JSON source. Assumes UTF-8 as fallback charset.
     *
     * @param aIS
    ...
    /**
     * Set a {@link Reader} as JSON source. Internally it is ensured, that it is buffered.
     *
     * @param aReader
     ...
     */
    @Nonnull
    public JsonBuilder trackPosition (final boolean bTrackPosition)
    {
      m_aParserSettings.setTrackPosition (bTrackPosition);
      return this;
    }
     ...
     */
    @Nonnull
    public JsonBuilder tabSize (@Nonnegative final int nTabSize)
    {
      m_aParserSettings.setTabSize (nTabSize);
      return this;
    }

    /**
     * @param bAlwaysUseBigNumber
     *        <code>true</code> to always use <code>BigDecimal</code> or <code>BigInteger</code>
     *        when reading numerical values.
     * @return this for chaining
     * @since v12.0.0
     */
    @Nonnull
    public JsonBuilder alwaysUseBigNumber (final boolean bAlwaysUseBigNumber)
    {
      m_aParserSettings.setAlwaysUseBigNumber (bAlwaysUseBigNumber);
      return this;
    }
     ...
     */
    @Nonnull
    public JsonBuilder requireStringQuotes (final boolean bRequireStringQuotes)
    {
      m_aParserSettings.setRequireStringQuotes (bRequireStringQuotes);
      return this;
    }

    /**
     * @param bAllowSpecialCharsInStrings
     *        <code>true</code> if special characters are allowed in a JSON string,
     *        <code>false</code> if not.
     * @return this for chaining
     * @since v12.0.0
     */
    @Nonnull
    public JsonBuilder allowSpecialCharsInStrings (final boolean bAllowSpecialCharsInStrings)
    {
      m_aParserSettings.setAllowSpecialCharsInStrings (bAllowSpecialCharsInStrings);
      return this;
    }
     ...
     */
    @Nonnull
    public JsonBuilder checkForEOI (final boolean bCheckForEOI)
    {
      m_aParserSettings.setCheckForEOI (bCheckForEOI);
      return this;
    }
     ...
     */
    @Nonnull
    public JsonBuilder maxNestingDepth (@Nonnegative final int nMaxNestingDepth)
    {
      m_aParserSettings.setMaxNestingDepth (nMaxNestingDepth);
      return this;
    }
    ...
    /**
     * @return <code>true</code> if a source is present, <code>false</code> if not.
     * @since 9.4.0
     */
    ...
    /**
     * Check if the provided source is syntactically correct JSON or not, without building an object
     * structure.
     *
    ...
    /**
     * @return The parsed JSON from the specified source. May be <code>null</code> if parsing fails.
     *         This method should be invoked only once per instance, because the underlying reader
     *         is not guaranteed to be re-openable.
     */
    @Nullable
    public IJson read ()
    {
      if (m_aReader == null)
        throw new IllegalStateException ("No source is set.");
      return JsonReader.readJson (_getEffectiveReader (), m_aParserSettings, m_aCustomExceptionCallback);
    }

    /**
     * @return The parsed JSON array from the specified source. May be <code>null</code> if parsing
     *         fails or if the parsed JSON is not an array. This method should be invoked only once
     *         per instance, because the underlying reader is not guaranteed to be re-openable.
     * @since 9.3.5
     */
    @Nullable
    ...
    /**
     * @return The parsed JSON array from the specified source. May be <code>null</code> if parsing
     *         fails or if the parsed JSON is not an object. This method should be invoked only once
     *         per instance, because the underlying reader is not guaranteed to be re-openable.
     * @since 9.3.5
     */
    @Nullable
    ...
    /**
     * @return The parsed JSON array from the specified source. May be <code>null</code> if parsing
     *         fails or if the parsed JSON is not a value. This method should be invoked only once
     *         per instance, because the underlying reader is not guaranteed to be re-openable.
     * @since 9.3.5
     */
    @Nullable
