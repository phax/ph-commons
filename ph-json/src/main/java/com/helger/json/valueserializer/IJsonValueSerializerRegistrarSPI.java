...
/**
 * SPI interface to be implemented by other modules wishing to register their own
 * {@link IJsonValueSerializer}.
 *
...
{
  /**
   * Register all your dynamic {@link IJsonValueSerializer} in the passed interface
   *
   * @param aRegistry
