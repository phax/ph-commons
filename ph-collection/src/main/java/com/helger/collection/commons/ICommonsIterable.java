...
public interface ICommonsIterable <ELEMENTTYPE> extends Iterable <ELEMENTTYPE>
{
  ...
  /**
   * A special version of {@link #forEach(Consumer)} that can break iteration if a certain
  ...
  /**
   * A special version of {@link #forEach(Consumer)} where a consumer can throw an exception.
   *
   * @param aConsumer
   *        The consumer to be invoked. May not be <code>null</code>.
   * @throws EXTYPE
  ...
  /**
   * Find all elements matching the supplied filter and invoke the provided consumer for each
   * matching element.
   *
   * @param aFilter
  ...
  /**
   * Convert all elements using the provided function and invoke the provided consumer for all
   * mapped elements.
   *
   * @param aMapper
   *        The mapping function to be executed for all elements. May not be <code>null</code>.
   * @param aConsumer
   *        The consumer to be invoked for all mapped elements. May not be <code>null</code>.
   * @param <DSTTYPE>
  ...
  /**
   * Find all elements matching the provided filter, convert the matching elements using the
   * provided function and invoke the provided consumer for all mapped elements.
   *
   * @param aFilter
   *        The filter to be applied. May be <code>null</code>.
   * @param aMapper
   *        The mapping function to be executed for all matching elements. May not be
   *        <code>null</code>.
   * @param aConsumer
   *        The consumer to be invoked for all matching mapped elements. May not be
   *        <code>null</code>.
   * @param <DSTTYPE>
   *        The destination type to be mapped to
   */
  ...
  /**
   * Convert all elements using the provided function, find all mapped elements matching the
   * provided filter and invoke the provided consumer for all matching elements.
   *
   * @param aMapper
   *        The mapping function to be executed for all matching elements. May not be
   *        <code>null</code>.
  ...
  /**
   * Find all elements that are <code>instanceOf</code> the provided class and invoke the provided
   * consumer for all matching elements. This is a special implementation of
   * {@link #findAllMapped(Predicate, Function, Consumer)}.
   *
   * @param aDstClass
   *        The class of which all elements should be find. May not be <code>null</code>.
   * @param aConsumer
   *        The consumer to be invoked for all instances of the provided class. May not be
   *        <code>null</code>.
   * @param <DSTTYPE>
  ...
  /**
   * Find the first element that matches the provided filter. If no element matches the provided
   * filter or if the collection is empty, <code>null</code> is returned by default. If this
   * collection does not maintain order (like Set) it is undefined which value is returned.
   *
   * @param aFilter
   *        The filter to be applied. May be <code>null</code>.
   * @return <code>null</code> if no element matches the filter or if the collection is empty, the
   *         first matching element otherwise.
  ...
  /**
   * Find the first element that matches the provided filter. If no element matches the provided
   * filter or if the collection is empty, the provided default value is returned. If this
   * collection does not maintain order (like Set) it is undefined which value is returned.
   *
   * @param aFilter
   *        The filter to be applied. May be <code>null</code>.
   * @param aDefault
   *        The default value to be returned if no element matches. May be <code>null</code>.
   * @return The provided default value if no element matches the filter or if the collection is
   *         empty, the first matching element otherwise.
  ...
  {
    return CollectionFind.findFirst (this, aFilter, aDefault);
  }

  /**
   * Find the first element that matches the provided filter and convert it using the provided
   * mapper. If no element matches the provided filter or if the collection is empty,
   * <code>null</code> is returned by default. If this collection does not maintain order (like Set)
   * it is undefined which value is returned.
   *
   * @param aFilter
   *        The filter to be applied. May be <code>null</code>.
   * @param aMapper
   *        The mapping function to be executed for the first matching element. May not be
   *        <code>null</code>.
   * @return <code>null</code> if no element matches the filter or if the collection is empty, the
   *         first matching element otherwise.
   * @param <DSTTYPE>
  ...
  /**
   * Find the first element that matches the provided filter and convert it using the provided
   * mapper. If no element matches the provided filter or if the collection is empty, the provided
   * default value is returned. If this collection does not maintain order (like Set) it is
   * undefined which value is returned.
   *
   * @param aFilter
   *        The filter to be applied. May be <code>null</code>.
   * @param aMapper
   ...
   * @param aFilter
   *        The filter to be applied. May be <code>null</code>.
   * @return <code>true</code> if the container is not empty and at least one element matches the
   *         provided filter, <code>false</code> otherwise. If no filter is provided the response is
   *         the same as {@link ICommonsCollection#isNotEmpty()}.
   */
  default boolean containsAny (@Nullable final Predicate <? super ELEMENTTYPE> aFilter)
  {
    return CollectionFind.containsAny (this, aFilter);
  }
   ...
   * @param aFilter
   *        The filter to be applied. May be <code>null</code>.
   * @return <code>true</code> if the container is empty or if no element matches the provided
   *         filter, <code>false</code> otherwise. If no filter is provided, this is the same as
   *         {@link ICommonsCollection#isEmpty()}.
   */
  default boolean containsNone (@Nullable final Predicate <? super ELEMENTTYPE> aFilter)
  {
    return CollectionFind.containsNone (this, aFilter);
  }

  /**
   * Check if this collection contains only (=all) elements matching the provided filter. If this
   * collection is empty, it does not fulfill this requirement! If no filter is provided the return
   * value is identical to {@link ICommonsCollection#isNotEmpty()}.
   *
   * @param aFilter
   *        The filter to be applied. May be <code>null</code>.
   * @return <code>true</code> if this collection is not empty and all elements matching the filter
   *         or if no filter is provided and this collection is not empty, <code>false</code>
  ...
  /**
   * Retrieve the size of this {@link Iterable}. This method does by default iterate all elements.
   * Please provide a more efficient solution. If this is a collection, consider using
   * <code>size()</code> instead.
   *
