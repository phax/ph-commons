                             ...
                             ICloneable <ICommonsMap <KEYTYPE, VALUETYPE>>
{
  ...
  default ICommonsSet <KEYTYPE> copyOfKeySet (@Nullable final Predicate <? super KEYTYPE> aFilter)
  {
    if (aFilter == null)
      return copyOfKeySet ();
    return CommonsHashSet.createFiltered (keySet (), aFilter);
  }
                                                               ...
                                                               @NonNull final Function <? super VALUETYPE, ? extends DSTTYPE> aMapper)
  {
    ...
    return CommonsArrayList.createFiltered (values (), aFilter, aMapper);
  }
  ...
  {
    return CollectionFind.containsAny (entrySet (), aFilter);
  }
  ...
  {
    return CollectionFind.containsAny (keySet (), aFilter);
  }
  ...
  {
    return CollectionFind.containsAny (values (), aFilter);
  }
