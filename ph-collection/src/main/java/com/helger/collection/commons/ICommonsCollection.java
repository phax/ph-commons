...
public interface ICommonsCollection <ELEMENTTYPE> extends Collection <ELEMENTTYPE>, ICommonsIterable <ELEMENTTYPE>
{
   ...
   * @return The number of elements matching the provided filter or the total number of elements if
   *         no filter is provided. Always &ge; 0.
   */
  @Override
  @Nonnegative
  ...
  /**
   * Get the element at the specified index or return <code>null</code> upon invalid index.
   *
   * @param nIndex
   ...
   *        The index to access. Should be &ge; 0.
   * @param aDefault
   *        The value to be returned, if the index is out of bounds. May be <code>null</code>.
  ...
  /**
   * Get the element at the specified index counting only elements matching the specified filter. If
   * no filter is provided this call is identical to {@link #getAtIndex(int)}.
   *
   * @param aFilter
   *        The filter to be applied. May be <code>null</code>.
   * @param nIndex
  ...
  /**
   * Get the element at the specified index counting only elements matching the specified filter or
   * return the provided default value upon invalid index. If no filter is provided this call is
   * identical to {@link #getAtIndex(int, Object)}.
   *
   * @param aFilter
   *        The filter to be applied. May be <code>null</code>.
   * @param nIndex
   ...
   *        The index to access. Should be &ge; 0.
   * @param aMapper
   *        The mapping function to be executed for the matching element. May not be
   *        <code>null</code>.
   * @return <code>null</code> if the element cannot be accessed.
   * @param <DSTTYPE>
  ...
  /**
   * Get the element at the specified index, counting only elements matching the provided filter and
   * map the resulting element using the provided mapper.
   *
   * @param aFilter
   *        The filter to be applied. May be <code>null</code>.
   * @param nIndex
   ...
   *        The mapping function to be executed for the matching element. May not be
   *        <code>null</code>.
   * @return <code>null</code> if no such element at the specified index was found.
   * @param <DSTTYPE>
   *        The destination type to be mapped to
   ...
   *        <code>null</code>.
   * @param aDefault
   *        The default value to be returned if no matching element could be found.
   * @return The provided default value if no such element at the specified index was found.
   * @param <DSTTYPE>
   *        The destination type to be mapped to
  ...
  /**
   * Return a sorted version of this collection. The default implementation returns a copy of this
   * collection as a {@link CommonsArrayList} and sort this list.
   *
   * @param aComparator
  ...
  /**
   * add the provided element to the collection using {@link #add(Object)} but returning a more
  ...
  /**
   * Add the passed element to this collection if it is non-<code>null</code>. This is an optimized
   * version for {@link #addIf(Object, Predicate)} with the fixed predicate of <code>!= null</code>.
   *
   * @param aElement
   ...
   *
   * @param aEnum
   *        The enumeration to be iterated and the elements to be added. May be <code>null</code>.
   * @return {@link EChange#CHANGED} if at least one element was added, {@link EChange#UNCHANGED}.
   *         Never <code>null</code>.
   */
  @NonNull
   ...
   *
   * @param aIter
   *        The iterator to be iterated and the elements to be added. May be <code>null</code>.
   * @return {@link EChange#CHANGED} if at least one element was added, {@link EChange#UNCHANGED}.
   *         Never <code>null</code>.
   */
  @NonNull
  ...
  /**
   * Add all passed elements matching the provided filter after performing a mapping using the
   * provided function.
   *
   * @param aElements
   *        The elements to be added after mapping. May be <code>null</code>.
   ...
   *        <code>null</code>.
   * @param aFilter
   *        The filter to be applied on the mapped element. May be <code>null</code>.
   * @return {@link EChange#CHANGED} if at least one element was added, {@link EChange#UNCHANGED}.
   *         Never <code>null</code>.
   * @param <SRCTYPE>
   *        The source type to be mapped from
  ...
  /**
   * Clear all elements and add all provided values. If no value is provided, the collection is
   * empty afterwards.
   *
   * @param aValues
  ...
  /**
   * Remove the provided element from the collection using {@link #remove(Object)} but returning a
   * more structured return value.
   *
   * @param aElement
