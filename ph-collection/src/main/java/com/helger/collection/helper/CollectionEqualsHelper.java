...
public final class CollectionEqualsHelper
{
  ...
  /**
   * This is a sanity method that first calls {@link CollectionHelperExt#getAsList(Object)} on both
  ...
  public static boolean equalsAsList (@Nullable final Object aObj1, @Nullable final Object aObj2)
  {
    ...
    final ICommonsList <?> aCollection1 = CollectionHelperExt.getAsList (aObj1);
    final ICommonsList <?> aCollection2 = CollectionHelperExt.getAsList (aObj2);
