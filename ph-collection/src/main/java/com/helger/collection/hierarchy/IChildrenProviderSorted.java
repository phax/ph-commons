...
public interface IChildrenProviderSorted <CHILDTYPE> extends IChildrenProvider <CHILDTYPE>
{
   ...
   *
   * @param aCurrent
   *        The object to determine the children of. May be <code>null</code> depending on the
  ...
  /**
   * Get the child of the passed object at the given index. It is assumed that objects are accessed
   * in exactly the same order as they are delivered by {@link #getAllChildren(Object)}.
   *
   * @param aCurrent
   *        The object to get the child of. May be <code>null</code> depending on the concrete
   *        implementation.
   * @param nIndex
