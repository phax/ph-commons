...
/**
 * Unit test for class {@link RingBufferLifo}.
 *
 * @author Philip Helger
 */
public final class RingBufferLifoTest
{
  ...
  public void testInvalid ()
  {
    try
    {
      new RingBufferLifo <String> (-1, true);
      fail ();
    }
    ...
    try
    {
      new RingBufferLifo <String> (0, true);
      fail ();
    }
    catch (final IllegalArgumentException ex)
    {}
    try
    {
      new RingBufferLifo <String> (-1, false);
      fail ();
    }
    catch (final IllegalArgumentException ex)
    {}
  ...
  {
    final RingBufferLifo <String> aRB = new RingBufferLifo <> (3, false);
  ...
  {
    final RingBufferLifo <String> aRB = new RingBufferLifo <> (3, true);
    assertEquals (3, aRB.getCapacity ());
    assertEquals (0, aRB.getAvailable ());
    assertEquals (3, aRB.getRemainingCapacity ());
    assertTrue (aRB.put ("a").isChanged ());
