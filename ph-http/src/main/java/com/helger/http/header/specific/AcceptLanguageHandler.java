...
public final class AcceptLanguageHandler
{
   ...
   *        The Accept-Language header value. May be <code>null</code> or empty.
   * @return A non-<code>null</code> {@link AcceptLanguageList} containing the parsed languages. If
   *         the input is empty, all languages are accepted.
   */
  @NonNull
