...
public class DoubleToString
{
  ...
  // private static final long DoubleFractMask = ~(DoubleSignMask |
  // DoubleExpMask);
  private static final int DoubleExpShift = 52;
  private static final int DoubleExpBias = 1023;

  private static final double [] d_tenthPowers = { 1e-323D,
                                                  1e-322D,
                                                  1e-321D,
                                                  1e-320D,
                                                  1e-319D,
                                        ...
                                        final char cDecimalPoint)
  {
    if (nValueMagnitude + nNumFractDigits == -1)
    {
      ...
      if (nValueMagnitude < -305)
        ...
        i = (int) ((dValue * 1E19) / d_tenthPowers[nValueMagnitude + 324 + 18]);
      else
        i = (int) (dValue / d_tenthPowers[nValueMagnitude + 323]);
  ...
  {
    long time1;
    final DoubleToString a = new DoubleToString ();
