...
import com.helger.commons.scope.singleton.tree.ApplicationSingletonTreeWithUniqueID;
...
public final class ApplicationSingletonTreeWithUniqueIDTest
{
  ...
  public void testBasic () throws Exception
  {
    ...
    assertSame (a,
                ApplicationSingleton.getApplicationSingletonIfInstantiated (MockApplicationSingletonTreeWithUniqueID.class));
