...
public final class FormattedObjectTest
{
  ...
  {
    CommonsTestUtils.testDefaultImplementationWithEqualContentObject (new FormattedObject ("Any", new BracketFormatter ()),
                                                                 new FormattedObject ("Any", new BracketFormatter ()));
    CommonsTestUtils.testDefaultImplementationWithDifferentContentObject (new FormattedObject ("Any",
    ...
    CommonsTestUtils.testDefaultImplementationWithEqualContentObject (new BracketFormatter (), new BracketFormatter ());

    CommonsTestUtils.testDefaultImplementationWithEqualContentObject (new MinLengthAddLeadingFormatter (10, ' '),
                                                                 new MinLengthAddLeadingFormatter (10, ' '));
    CommonsTestUtils.testDefaultImplementationWithDifferentContentObject (new MinLengthAddLeadingFormatter (10, ' '),
                                                                     new MinLengthAddLeadingFormatter (10, 'x'));
    CommonsTestUtils.testDefaultImplementationWithDifferentContentObject (new MinLengthAddLeadingFormatter (10, ' '),
                                                                     new MinLengthAddLeadingFormatter (5, ' '));

    CommonsTestUtils.testDefaultImplementationWithEqualContentObject (new MinLengthAddTrailingFormatter (10, ' '),
                                                                 new MinLengthAddTrailingFormatter (10, ' '));
    CommonsTestUtils.testDefaultImplementationWithDifferentContentObject (new MinLengthAddTrailingFormatter (10, ' '),
                                                                     new MinLengthAddTrailingFormatter (10, 'x'));
    CommonsTestUtils.testDefaultImplementationWithDifferentContentObject (new MinLengthAddTrailingFormatter (10, ' '),
                                                                     new MinLengthAddTrailingFormatter (5, ' '));

    CommonsTestUtils.testDefaultImplementationWithEqualContentObject (new StringPrefixAndSuffixFormatter ("p", "s"),
                                                                 new StringPrefixAndSuffixFormatter ("p", "s"));
    CommonsTestUtils.testDefaultImplementationWithDifferentContentObject (new StringPrefixAndSuffixFormatter ("p", "s"),
                                                                     new StringPrefixAndSuffixFormatter ("p", "ss"));
    CommonsTestUtils.testDefaultImplementationWithDifferentContentObject (new StringPrefixAndSuffixFormatter ("p", "s"),
                                                                     new StringPrefixAndSuffixFormatter ("pp", "s"));

    CommonsTestUtils.testDefaultImplementationWithEqualContentObject (new StringPrefixFormatter ("p"),
                                                                 new StringPrefixFormatter ("p"));
    CommonsTestUtils.testDefaultImplementationWithDifferentContentObject (new StringPrefixFormatter ("p"),
                                                                     new StringPrefixFormatter ("pp"));

    CommonsTestUtils.testDefaultImplementationWithEqualContentObject (new StringSuffixFormatter ("s"),
                                                                 new StringSuffixFormatter ("s"));
    CommonsTestUtils.testDefaultImplementationWithDifferentContentObject (new StringSuffixFormatter ("s"),
