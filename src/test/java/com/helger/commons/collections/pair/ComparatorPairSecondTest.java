...
public final class ComparatorPairSecondTest
{
  ...
  public void testAll ()
  {
    ...
    CollectionHelper.getSortedInline (aList, new ComparatorPairSecond <String, String> ());
    assertEquals (3, aList.size ());
    assertEquals ("k1", aList.get (0).getFirst ());
    assertEquals ("k2", aList.get (1).getFirst ());
    assertEquals ("k3", aList.get (2).getFirst ());

    CollectionHelper.getSortedInline (aList, new ComparatorPairSecond <String, String> (ESortOrder.DESCENDING));
    assertEquals (3, aList.size ());
    assertEquals ("k3", aList.get (0).getFirst ());
    assertEquals ("k2", aList.get (1).getFirst ());
    assertEquals ("k1", aList.get (2).getFirst ());

    final List <IPair <String, String>> aList2 = PairUtils.getSortedByPairSecond (aList);
