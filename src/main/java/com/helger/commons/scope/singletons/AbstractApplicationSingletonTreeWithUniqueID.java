 ...
 * {@link AbstractApplicationSingleton} wrapping a {@link DefaultTreeWithGlobalUniqueID}
 * with the same API.
 *
 ...
 *        Tree value type
 */
public abstract class AbstractApplicationSingletonTreeWithUniqueID <KEYTYPE, VALUETYPE> extends AbstractApplicationSingleton implements ITreeWithGlobalUniqueID <KEYTYPE, VALUETYPE, DefaultTreeItemWithID <KEYTYPE, VALUETYPE>>
{
