...
public final class ArrayIteratorByte
{
   ...
   *        Lenght. Must be &ge; 0.
   */
  private ArrayIteratorByte (@Nonnull final byte [] aArray, @Nonnegative final int nOfs, @Nonnegative final int nLength)
  {
  ...
  {
    return new ArrayIteratorByte (aArray, nOfs, nLength);
  }
