 ...
 *
 * @see com.helger.scopes.mgr.EScope#SESSION_APPLICATION
...
public abstract class SessionApplicationSingleton extends AbstractSingleton implements Serializable
{
   ...
   */
  @Nonnull
  public static final <T extends SessionApplicationSingleton> T getSessionApplicationSingleton (@Nonnull final Class <T> aClass)
  {
